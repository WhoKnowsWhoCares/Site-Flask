...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_user_role(self):
        u = User(username='john', email='john@example.com', password='cat', role=UserRole.USER)
        self.assertTrue(u.can(UserRole.USER))
        self.assertFalse(u.can(UserRole.ADMIN))
        self.assertFalse(u.is_administrator())

    def test_administrator_role(self):
        u = User(username='john', email='john@example.com', password='cat', role=UserRole.ADMIN)
